...
while robot.step(timestep) != -1:
    ...
    if (movement!=2 and movement!=3 and movement!=4):
        movement = random_movement(movement, random_turn)
        
    if (movement!=1 and movement!=0):
        move_forward_till_wall_detection(movement,random_turn)
